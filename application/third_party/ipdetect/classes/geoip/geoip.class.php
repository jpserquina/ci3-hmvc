<?php
	...
	class geoIp {
		...
		public function __construct($aLocalConfiguration=null)
		{
			...
			if ( array_key_exists($this->getIPAddress(), $aAllowedIPs) )
		        if(!defined('ALLOWED_BY_IP')) define('ALLOWED_BY_IP', $aAllowedIPs[$this->getIPAddress()]);
		    else
				if(!defined('ALLOWED_BY_IP')) define('ALLOWED_BY_IP', false);
		}
